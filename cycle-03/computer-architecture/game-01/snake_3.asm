...
DESPLAZAMIENTO_SNAKE:
    ...
    MOV CX, 8   ; tamaño del cuerpo del snake
    MOV SI, 14  ; posición de la cola
                    
    DIBUJAR_CUERPO:
        MOV BX, CUERPO_SNAKE[SI]  
        MOV WORD PTR ES:[BX], 0A3Eh    ; 0Ah: verde fosforecente y fondo negro, 3Eh: caracter '>' 
        ADD SI, -2
        LOOP DIBUJAR_CUERPO
    ...
    ADD CUERPO_SNAKE[SI], 2
    MOV BX, CUERPO_SNAKE[SI]
    MOV WORD PTR ES:[BX], 0A3Eh
