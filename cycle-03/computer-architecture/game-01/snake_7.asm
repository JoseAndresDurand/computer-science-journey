...
DESPLAZAMIENTO_SNAKE:
    ...
    ; Le damos al desplazamiento de la cabeza el color verde y caracter cuadrado
...
VECTOR_DIRECCION DW 2   ;dirección predeterminada para la derecha.    
FONDO_VACIO DW 0000h    ;valor predeterminado para la variable